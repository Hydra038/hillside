        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center mb-3">
              {/* Logo/Icon */}
              <div className="bg-amber-600 p-2 rounded-full mr-3 shadow-lg">
              ...
              <div>
                <h2 className="text-2xl font-bold text-amber-400 font-heading">Hillside Logs Fuel</h2>
                <p className="text-gray-300 text-xs mt-1">Premium Quality Firewood</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-semibold mb-4 text-amber-400 font-heading relative">
                Contact Us
                <div className="absolute -bottom-1 left-0 w-8 h-0.5 bg-amber-600"></div>
              </h3>
              <ul className="space-y-3">
                <li className="flex items-center group">
                  <div className="bg-gray-700 p-2 rounded-lg mr-3 group-hover:bg-amber-600 transition-colors duration-300">
                  ...
                  <a href="https://wa.me/447878779622" target="_blank" rel="noopener noreferrer" 
                     className="hover:text-amber-400 transition-colors duration-300 text-sm">
                    +44 7878 779622
                  </a>
                </li>
                <li className="flex items-center group">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <a 
                  ...
                  className="flex items-center p-3 bg-gray-700 rounded-lg hover:bg-blue-600 transition-all duration-300 group"
                >
              ...
              {/* Quality Badge */}
              <div className="bg-gradient-to-r from-amber-600 to-amber-500 p-3 rounded-lg text-center">
