...
async function createSampleProducts() {
  try {
    ...
    // First, try to create the products table if it doesn't exist
    try {
      await sql`
    ...
    const sampleProducts = [
      ...
      },
      {
        ...
        description: 'A variety of seasoned hardwoods including ash, beech, and birch. Great value for money with consistent burning properties.',
        price: 38.50,
        category: 'Hardwood',
        stock_quantity: 75,
